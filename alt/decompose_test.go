...
func TestDecomposeStruct(t *testing.T) {
	...
	tt.Equal(t, map[string]any{
		"^":   "github.com/CodingBingo/ojg/alt_test/Dummy",
		"val": 3,
		"nest": map[string]any{
			"^":   "github.com/CodingBingo/ojg/alt_test/Dummy",
			"val": 2,
...
func TestDecomposeEmbeddedStruct(t *testing.T) {
	...
	tt.Equal(t, map[string]any{
		"^":     "github.com/CodingBingo/ojg/alt_test/Bummy",
		"dummy": map[string]any{"^": "github.com/CodingBingo/ojg/alt_test/Dummy", "val": 3}, "num": 5}, v)
